...
//Used postId instead of formData._id as it was giving an undefined value.
    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen' >
        ...
        <form className='flex flex-col gap-4 ' onSubmit={handleSubmit} >
            ...
            <div className='flex gap-4 items-center justify-between border-4
              ...
              <ReactQuill theme='snow' value={formData.content} placeholder='Wrtie Something...' 
               className='h-72 mb-12' required onChange={
                (value)=>{
                  setFormData({
